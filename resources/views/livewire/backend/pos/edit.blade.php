...
<div>
    ...
    <div class="row position-fixed fixed-bottom bg-white">
        <div class="col-12 text-center">
            <button type="button" wire:click="editData('pending')" class="btn btn-success">
                <i class="fa fa-money"></i> {{ __('Pending') }}
            </button>
            <button type="button" wire:click="editData('processing')" class="btn btn-primary">
                <i class="fa fa-money"></i> {{ __('Processing') }}
            </button>
            <button type="button" wire:click="editData('delivered')" class="btn btn-info">
                <i class="fa fa-money"></i> {{ __('Delivered') }}
            </button>
            {{-- <button type="button" wire:click="editData('pending')" class="btn btn-info">
                <i    class="fa fa-money"></i> {{ __('Pending') }}
            </button> --}}
...
@push('js')
    ...
    <script>
        ...
        $(document).ready(function () {
            @this.get('selectedTable').forEach(element => {
                console.log(element);
                bookedTable.push(element);
        ...
        function selectedTable(tableId, here){
            bookedTable.forEach(value => {
                console.log(value);
            });
        //   if($.inArray(tableId, bookedTable.values()) != 0){
        //     console.log(tableId, bookedTable.values(), 'in');
