            ...
            <div class="row flex-row-reverse">
                ...
                <div class="col-lg-3 primary-sidebar sticky-sidebar">
                    <div class="widget-category mb-30">
                        <h5 class="section-title style-1 mb-30 wow fadeIn animated">Childcategory</h5>
                        <ul class="categories">
                            @forelse ($subcategory->childcategories as $childcategory)
                                <li><a href="javascript:void(0)"  wire:click="selectChildCat({{$childcategory->id}})">{{$childcategory->name}}</a></li>
                            @empty
