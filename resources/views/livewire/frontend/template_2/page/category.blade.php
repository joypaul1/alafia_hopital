                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 order-lg-first mt-4 pt-2 mt-lg-0 pt-lg-0">
                        <div class="sidebar">
                            ...
                            <div class="widget">
                                <h5 class="widget_title">Subcategory :</h5>
                                <ul class="list_brand">
                                    @forelse ($category->subcategories as $subKey=>$subcategory)
                                    <li>
                                        <div class="custome-checkbox">
                                            <input class="form-check-input" type="checkbox" name="subcategorycheckbox"
                                                id="{{$subKey}}"  wire:click="selectSubCat({{$subcategory->id}})" value="">
                                            <label class="form-check-label" for="{{$subKey}}"><span>{{$subcategory->name}}</span></label>
                                        </div>
                                    </li>
                                    @empty
                                    @endforelse
