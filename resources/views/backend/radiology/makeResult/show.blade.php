            ...
            <div style="padding: 0 0.5in;">
                <table class="c55">
                    ...
                    <tr class="c5">
                        ...
                        @php
                        $bday = new DateTime(optional(optional($radiologyServiceInvoiceItem->serviceInvoice)->patient)->dob); // Your date of birth
                        $today = new Datetime(date('m.d.y'));
                        $diff = $today->diff($bday);
                        @endphp
                        <td class="c36" colspan="1" rowspan="1">
                            <p class="c23 c10"><span class="c13">{{ optional(optional($radiologyServiceInvoiceItem->serviceInvoice)->patient)->name }}</span></p>
                        </td>
                        ...
                        <td class="c15" colspan="1" rowspan="1">
                            <p class="c23"><span class="c0">{{ date('d-m-Y H:i', strtotime($radiologyServiceInvoiceItem->created_at)) }}</span></p>
                        </td>
                    </tr>
                    <tr class="c5">
                        <td class="c32" colspan="1" rowspan="1">
                    ...
                    <tr class="c5">
                        ...
                        <td class="c36" colspan="1" rowspan="1">
                            <p class="c23"><span class="c0">{{ optional(optional($radiologyServiceInvoiceItem->serviceInvoice)->patient)->gender }}</span></p>
                        </td>
