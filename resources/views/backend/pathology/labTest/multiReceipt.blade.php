...
<body>
    <div class="prescription">
        @foreach ($labTestDetails as $key => $labTestDetail)
                    ...
                    <tbody>
                        ...
                        @foreach ($labTestDetail as $testDetail)
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    {{ round($testDetail['discount']) }}
                                    {{ $testDetail['discount_type'] == 'percentage' ? '%' : 'TK' }}
                                </td>
                                <td class="text-right">
                                    {{ number_format($testDetail['subtotal'], 2) }}
                                </td>

                                <td>
                                    {{ date('d-m-Y h:i A', strtotime($testDetail['delivery_time'])) }}
                                    {{-- {{ date_format(($testDetail['delivery_time']), 'd-m-Y h:i A') }} --}}
                                </td>
                            </tr>
                        @endforeach
