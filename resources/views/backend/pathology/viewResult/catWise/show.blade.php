                ...
                <table class="c55">
                    <tr class="c5">
                        ...
                        <td class="c43" colspan="1" rowspan="1">
                            <p class="c23 c10"><span class="c13">{{ $invoice_no }}</span></p>
                        </td>
                        ...
                        <td class="c45" colspan="1" rowspan="1">
                            <p class="c23"><span class="c0">{{ date('d-m-Y H:i', strtotime($date)) }}</span></p>
                        </td>
                    </tr>
                    <tr class="c5">
                        ...
                        @php
                        $bday = new DateTime($patient->dob); // Your date of birth
                        $today = new Datetime(date('m.d.y'));
                        $diff = $today->diff($bday);
                        @endphp
                        <td class="c36" colspan="1" rowspan="1">
                            <p class="c23 c10"><span class="c13">{{ $patient->name }}</span></p>
                        </td>
                    ...
                    <tr class="c5">
                        ...
                        <td class="c36" colspan="1" rowspan="1">
                            <p class="c23"><span class="c0">{{ $patient->gender }}</span></p>
                        </td>
                        <td class="c42" colspan="1" rowspan="1">
