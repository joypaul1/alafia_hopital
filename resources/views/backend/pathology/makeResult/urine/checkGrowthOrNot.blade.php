...
@section('content')
    <div>
        <div class="card">
            <div class="body">
                <h5 class="mb-3">
                    <i class="fa fa-flask"></i> {{ $labTest->category }} Report <i class="fa fa-arrow-right" aria-hidden="true"></i> {{ $labTest->name }}
                </h5>
