    ...
    <div class="content">
        <div>
            <div style="display: flex; justify-content: space-between;align-items: center; margin-bottom: 1rem;">
                ...
                <h2 style="margin: 0; padding: 0; color: #f97316; text-align: center;">
                    Al-Afiyah Pathology Unit
                </h2>
                <img src="./logo.png" style="width: 90px;" alt="">
                <!-- <div style="text-align: right;">
                    <h2 style="margin: 0; padding: 0; color: #f97316; text-align: right;">
                        Al-Afiyah Dialysis Unit
                    </h2>
                    <p style="margin-bottom: 10px">
                        Powered By <strong>BIPSH</strong>
                    </p>
                    <p style="font-size: 12px;">
                        House 13, Road-2, Dhanmondi <br> Dhaka, Bangladesh
                    </p>
                    <p style="font-size: 12px;">
                        Phone: +8801844-583151
                    </p>
                    <p style="font-size: 12px;">
                        Email: alafiayah@gmail.com
                    </p>
                    <p style="font-size: 12px;">
                        Website: https://www.alafiyahbd.com/
                    </p>
                    <p style="font-size: 12px;">
                        <strong>
                            Al-Afiyah Dialysis Unit
        ...
        <footer>
            ...
            <div style="display: flex;justify-content: space-between;">
                <div>
                    <strong>Hotline:</strong> +8801844-583151
                </div>
                <div style="text-align: right;">
                    <p style="font-size: 12px;">
