...
@endpush
@section('page-header')
<i class="fa fa-plus-circle"></i> Module Update
@stop
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="form-validation">
                    <form  action="{{ route('backend.modules.update', $module) }}" method="Post" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf

                        <div class="form-group">
                            @include('components.backend.forms.input.input-type',[ 'name' => 'name', 'value' => old('title',$role->name), 'placeholder' => 'text will be here...' ])
