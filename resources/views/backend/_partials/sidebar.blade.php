                    ...
                    <ul id="main-menu" class="metismenu">
                        ...
                        {{-- <li class="{{ strpos($strpos, 'backend.itemconfig') === 0 ? 'active' : ' ' }}">
                            ...
                            <ul>
                                <x-backend.side-bar class="{{ request()->segment(3) == 'item' ? 'active' : ' ' }}"
                                    name="Item" link='backend.itemconfig.item.index' icon='#' />
                                ...
                                <x-backend.side-bar class="{{ request()->segment(3) == 'brand' ? 'active' : ' ' }}"
                                    name="Brand" link='backend.itemconfig.brand.index' icon='#' />
                        ...
                        {{-- <li class="{{ strpos($strpos, 'backend.report') === 0 ? 'active' : ' ' }}">
                            ...
                            <ul>
                                ...
                                <x-backend.side-bar class="{{ request()->segment(2) == 'sell-report' ? 'active' : ' ' }}"
                                    name="Sell Report" link='backend.report.sellReport' icon='#' />
                                <x-backend.side-bar class="{{ request()->segment(2) == 'purchase-report' ? 'active' : ' ' }}"
                                        name="Purchase Report" link='backend.report.purchaseReport' icon='#' />
                                <x-backend.side-bar class="{{ request()->segment(2) == 'income-report' ? 'active' : ' ' }}"
                                            name="Income Report" link='backend.report.incomeReport' icon='#' />
                                <x-backend.side-bar class="{{ request()->segment(2) == 'expense-report' ? 'active' : ' ' }}"
                        ...
                        <li class="{{ strpos($strpos, 'backend.siteconfig') === 0 ? 'active' : ' ' }}">
                            ...
                            <ul>
                                ...
                                <x-backend.side-bar
                                    ...
                                    name="Socail Media Config" link='backend.siteconfig.socialmedia.index' icon='#' />
                                <x-backend.side-bar
