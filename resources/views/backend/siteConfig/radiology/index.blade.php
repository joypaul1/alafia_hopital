...
@section('page-header')
    <i class="fa fa-list"></i> Radiology Service Config
@stop
            ...
            <div class="card">
                <div class="body">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <a id="create_data" data-href="{{ route('backend.siteConfig.radiology_serviceName.create') }}"
    ...
    <script>
        ...
        $(function() {
            table_name = $("#service_table").DataTable({
                ...
                pagingType: 'numbers',
                pageLength: 10,
                ajax: "{{ route('backend.siteConfig.radiology_serviceName.index') }}",
                ajax: {
                    method: 'GET',
