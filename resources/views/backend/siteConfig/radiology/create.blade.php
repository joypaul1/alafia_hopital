<div class="modal-content">
    <form class="needs-validation" id="service_add_form" action="{{ route('backend.siteConfig.radiology_serviceName.store') }}" method="Post" enctype="multipart/form-data">
        @method('POST')
        @csrf
        <div class="modal-header">
            <h4 class="title">Radiology Service Add</h4>
        </div>
