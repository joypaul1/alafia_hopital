...
<div class="modal-content">
    <form class="needs-validation" id="serviceType_add_form" action="{{ route('backend.siteConfig.serviceType.store') }}" method="Post"
        enctype="multipart/form-data">
        @method('POST')
        @csrf
        <div class="modal-header">
            <h4 class="title" id="">ServiceType Add</h4>
        </div>
        ...
        <div class="modal-footer">
            ...
            <button type="submit" class="btn btn-outline-primary save_serviceType_button">SAVE</button>
        </div>
    </form>
</div>
