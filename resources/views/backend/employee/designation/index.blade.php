...
@include('backend._partials.page_header', [
    ...
    'route' => route('backend.employee.designation.create')
 ])
                            ...
                            @forelse ($designations as $key=>$item)
                                <tr>
                                    ...
                                    <td  class="text-center">
                                        <a href="{{ route('backend.employee.designation.edit', $item) }}" class="btn btn-sm btn-icon btn-warning  m-r-5" data-toggle="tooltip" data-original-title="Edit"><i class="icon-pencil" aria-hidden="true"></i>
                                        </a>
                                        <button   type="button" 
                                        ...
                                        <form action="{{ route('backend.employee.designation.destroy', $item)}}"
