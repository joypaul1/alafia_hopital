...
@endpush
@section('page-header')
<i class="fa fa-pencil"></i> Shift Edit
@stop
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="form-validation">
                    <form class="needs-validation" action="{{ route('backend.employee.shift.update', $shift) }}" method="Post" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="mb-3 row">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-lg-8">
                                <div class="input-group  demo-masked-input">
                                    ...
                                    <input type="text"  name="end_time" value="{{ $shift->end_time??'-' }}" class="form-control time12" placeholder="Ex: 06:00 pm">
                                </div>
