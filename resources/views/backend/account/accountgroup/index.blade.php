...
@section('page-header')
<i class="fa fa-list"></i> Account Group List
@stop
...
'route' => route('backend.account.accountgroup.create')
])
        ...
        <div class="card border-top">
            ...
            <div class="body">
                <div class="table-responsive">
                    <table class="table table-bordered text-center dataTable" id="accountgroup_table">
                        <thead>
                            <tr>
...
<div class="modal fade accountgroup_modal" tabindex="-1" role="dialog">
...
<script>
    let table_name ;
    var modal = ".accountgroup_modal";
    $(function() {
        table_name =$("#accountgroup_table").DataTable({
            dom: "Bfrtip",
            ...
            pagingType: 'numbers',
            pageLength: 10,
            ajax: "{{ route('backend.account.accountgroup.index') }}",
            ajax: {
                method:'GET',
                url : "{{ route('backend.account.accountgroup.index') }}",
                data : function ( d ) {
    ...
    $(document).on('submit', 'form#accountgroup_edit_form', function(e) {
        e.preventDefault();
