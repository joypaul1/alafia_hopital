...
<div class="modal-content">
    <form class="needs-validation" id="accountgroup_add_form" action="{{ route('backend.account.accountgroup.store') }}" method="Post"
        enctype="multipart/form-data">
        @method('POST')
        @csrf
        <div class="modal-header">
            <h4 class="title" id="">Account Group Add</h4>
        </div>
        <div class="modal-body">
            <div class="form-validation">
                ...
                <div class="form-group">
                    @include('components.backend.forms.select2.option',['label' => 'Account Head','name' => 'account_head_id', 'optionDatas'=>$account_heads, 'required'=> true ])
        ...
        <div class="modal-footer">
            <button type="submit" class="btn btn-primary save_accountgroup_button">SAVE</button>
