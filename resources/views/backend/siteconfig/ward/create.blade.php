...
<div class="modal-content">
    <form class="needs-validation" id="bedWard_add_form" action="{{ route('backend.siteconfig.bedWard.store') }}" method="Post"
        enctype="multipart/form-data">
        @method('POST')
        @csrf
        <div class="modal-header">
            <h4 class="title" id="">Ward Add</h4>
        </div>
        ...
        <div class="modal-footer">
            <button type="submit" class="btn btn-outline-primary save_bedWard_button">SAVE</button>
