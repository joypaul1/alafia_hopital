...
@endpush
@section('page-header')
<i class="fa fa-pencil"></i> Transaction Edit
@stop
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="form-validation">
                    <form class="needs-validation" action="{{ route('backend.report.transaction.update', $size) }}" method="Post" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="mb-3 row">
