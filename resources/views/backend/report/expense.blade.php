...
@section('page-header')
<i class="fa fa-list"></i> Expense Report
@stop

@section('table_header')
<h3 class="text-center">Expense Statement</h3>
@stop
@section('content')
                ...
                <table class="table table-striped table-bordered table-hover table-sm">
                    ...
                    <tbody>
                        ...
                        @php
                            $ledgerBalance = 0.00;
                        @endphp
                        @forelse ($othersExpense->groups as $group )
                        ...
                        <tr>
                            <th colspan="" style="text-align: right;">Total Operating Expense</th>
                            <td></td>
