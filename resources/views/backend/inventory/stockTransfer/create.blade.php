                        ...
                        <div class="col-12">
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <h6>Acer Aspire E15 (Color: Black)</h6>
                                        </td>
                                        <td>
                                        ...
                                        <td><input type="number" value="437.50" class="form-control"></td>
                                        <td><input type="text" disabled value="437.50" class="form-control"></td>
                                        <td> <i class="fa fa-trash" data-toggle="modal" data-target="#discountModal" style="cursor:pointer; font-size: 16px;" aria-hidden="true"></i></td>
                                    </tr>
                                    <tr>
                                        <th colspan="3"></th>
                                        <td colspan="2">
