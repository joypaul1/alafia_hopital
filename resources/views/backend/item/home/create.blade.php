...
<div class="row">
    <div class="col-lg-12">
        <form class="needs-validation" action="{{ route('backend.itemconfig.item.store') }}" method="Post" enctype="multipart/form-data">
            @method('POST')
            @csrf
                    ...
                    <div class="form-validation">
                        <div class="mb-3 row">
                            <div class="col-lg-4">
                                ...
                                => 'Product name here...', 'required'=> true ])
                            ...
                            <div class="col-lg-4">
                                @include('components.backend.forms.select2.option',[ 'label' =>'unit', 'name' => 'unit_id','optionDatas'=>[], 'required'=> true ])
                                @include('components.backend.forms.input.errorMessage', ['message' => $errors->first('unit_id')])
                            </div>
                            <div class="col-lg-4">
                                @include('components.backend.forms.select2.option',['label' =>'Brand', 'name' => 'brand_id','optionDatas'=>[], 'required'=> true ])
                                @include('components.backend.forms.input.errorMessage', ['message' =>$errors->first('brand_id')])
                            </div>

                            <div class="col-lg-4">
                                @include('components.backend.forms.select2.option',[ 'label' =>'Category', 'name' => 'category_id','optionDatas'=>[], 'required'=> true ])
                                @include('components.backend.forms.input.errorMessage', ['message' => $errors->first('category_id')])
                            </div>
                            <div class="col-lg-4">
                                @include('components.backend.forms.select2.option',[ 'label' =>'sub_category',  'name' => 'subcategory_id','optionDatas'=>[], 'required'=> true ])
                                @include('components.backend.forms.input.errorMessage', ['message' =>$errors->first('subcategory_id')])
                            </div>
                            <div class="col-lg-4">
                                @include('components.backend.forms.select2.option',[ 'label' =>'child_category', 'name' => 'childcategory_id', 'optionDatas'=>[],])
                                @include('components.backend.forms.input.errorMessage', ['message' => $errors->first('childcategory_id')])
                            </div>
                            <div class="col-lg-4">
                                @include('components.backend.forms.select2.option',[ 'label' => 'origin', 'name' => 'origin_id', 'optionDatas'=>$countries ])
                                @include('components.backend.forms.input.errorMessage', ['message' =>$errors->first('origin_id')])
                            </div>

                            <div class="col-lg-4">
                                @include('components.backend.forms.input.input-type',[ 'name' => 'alert_quantity', 'placeholder' => 'Product alert quantity here ...', 'number'=> true ])
                            ...
                            <div class="col-lg-4">
                                @include('components.backend.forms.input.input-type',[ 'name' => 'weight', 'number'=>true , 'placeholder' => 'Weight here ...' ])
                    ...
                    <div class="form-validation">
                        <div class="mb-3 row">
                            ...
                            <div class="col-lg-4 pt-2">
                                @include('components.backend.forms.dropdown.option',[ 'label'=>'Applicable Tax Rate' , 'name' => 'tax_type','optionDatas'=>$appilcationTax, 'required'=> true ])
                                @include('components.backend.forms.input.errorMessage', ['message' => $errors->first('tax_type')])
                            </div>
                            <div class="col-lg-4">
                                @include('components.backend.forms.dropdown.option',[ 'label' =>'Selling Price Tax Type','name' => 'tax_id', 'optionDatas'=>$taxs, 'required'=> true ])
                                @include('components.backend.forms.input.errorMessage', ['message' => $errors->first('tax_id')])
                            </div>
                            <div class="col-lg-4">
                                @include('components.backend.forms.dropdown.option',[ 'name' => 'product_type', 'optionDatas'=>$product_types, 'required'=> true ])
                        ...
                        <table class="table table-hover costing_table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        @include('components.backend.forms.input.input-type',['label' =>'Exclusive Tax', 'value'=>0, 'name' => 'exc_tax', 'placeholder' => 'Exc. tax ', 'number' => true, 'required'=> true ])
                                        @include('components.backend.forms.input.errorMessage', ['message' => $errors->first('exc_tax')])
                                    </td>
                                    <td>
                                        @include('components.backend.forms.input.input-type',['label' =>'Tax Rate','value'=>0, 'readonly'=>true,'name' => 'tax_rate', 'placeholder' => 'tax rate ', 'number' => true, 'required'=> true ])
                                        @include('components.backend.forms.input.errorMessage', ['message' => $errors->first('tax_rate')])
                                    </td>
                                    <td>
                                        @include('components.backend.forms.input.input-type',[ 'label' => 'Inclusive Tax','value'=>0, 'name'=>'inc_tax', 'placeholder' => 'Inc. tax','number' => true, 'required'=> true ])
                                        @include('components.backend.forms.input.errorMessage', ['message' => $errors->first('inc_tax')])
                                    </td>
                                    <td>
                                        @include('components.backend.forms.input.input-type',[ 'name' => 'profit_percent','value'=>0, 'placeholder' => 'profit (25%)', 'number' => true, 'required'=> true ])
                                        @include('components.backend.forms.input.errorMessage', ['message' => $errors->first('profit_percent')])
                                    </td>

                                    <td>
                                        @include('components.backend.forms.input.input-type',[ 'name' => 'sell_price','value'=>0, 'placeholder' => 'selling price', 'number' => true, 'required'=> true ])
...
@include('backend.item.home.itemJs',['category_id' =>null, 'brand_id'=> null,
'unit_id' =>null, 'rack_id' => null
] );
@endsection
@push('js')
