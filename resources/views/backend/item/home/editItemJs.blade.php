    ...
    $.ajax({
        ...
        success: function(res) {
            $.map(res.data, function(val, i) {
                ...
                $('#brand_id').val("{{$item->unit_id}}").trigger('change');
    ...
    $.ajax({
        ...
        success: function(res) {
            $.map(res.data, function(val, i) {
                ...
                $('#rack_id').val("{{$item->unit_id}}").trigger('change');
        ...
        $.ajax({
            ...
            success: function(res) {
                ...
                $.map(res.data, function(val, i) {
                    ...
                    $('#row_id').val("{{$item->row_id}}").trigger('change');
        ...
        $.ajax({
            ...
            success: function(res) {
                ...
                $.map(res.data, function(val, i) {
                    ...
                    $('#subcategory_id').val("{{$item->subcategory_id}}").trigger('change');
        ...
        $.ajax({
            ...
            success: function(res) {
                ...
                $.map(res.data, function(val, i) {
                    ...
                    $('#childcategory_id').val("{{$item->childcategory_id}}").trigger('change');
