...
'route' => route('backend.itemconfig.subcategory.create')
])
        ...
        <div class="card border-top">
            ...
            <div class="body">
                <div class="table-responsive">
                    <table class="table table-bordered text-center dataTable" id="subcategory_table">
                        <thead>
                            <tr>
...
<div class="modal fade subcategory_modal" tabindex="-1" role="dialog">
...
<script>
    let table_name ;
    var modal = ".subcategory_modal";
    $(function() {
        table_name =$("#subcategory_table").DataTable({
            dom: "Bfrtip",
            ...
            pagingType: 'numbers',
            pageLength: 10,
            ajax: "{{ route('backend.itemconfig.subcategory.index') }}",
            ajax: {
                method:'GET',
                url : "{{ route('backend.itemconfig.subcategory.index') }}",
                data : function ( d ) {
...
<script>
    $(document).on('submit', 'form#subcategory_add_form', function(e) {
        e.preventDefault();
