<div class="modal-content">
    <form class="needs-validation" id="generic_add_form" action="{{ route('backend.itemconfig.generic-name.store') }}"
        method="Post" enctype="multipart/form-data">
        @method('POST')
        @csrf
        <div class="modal-header">
            <h4 class="title" id=""><i class="fa fa-plus-circle" aria-hidden="true"></i> Generic Add</h4>
        </div>
        ...
        <div class="modal-footer">
            <button type="submit" class="btn btn-primary save_generic_button">SAVE</button>
