...
<select class="form-control show-tick ms select2 {{ $name }}" id="{{ $name }}" name="{{ $name }}"
    @isset($multiple) multiple @endisset
    @isset($onclick) onclick="dataBaseCall()" @endisset
    @isset($onchange) onchange="dataBaseCall()" @endisset
