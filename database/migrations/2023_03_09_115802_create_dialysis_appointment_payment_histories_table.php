...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('dialysis_appointment_payment_histories', function (Blueprint $table) {
            $table->id();
            $table->foreignId('appointment_id')->constrained('dialysis_appointments');
            $table->date('date');
    ...
    {
        Schema::dropIfExists('dialysis_appointment_payment_histories');
    }
};
