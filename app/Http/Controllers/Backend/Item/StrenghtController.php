...
class StrenghtController extends Controller
{
    ...
    {
        if(auth('admin')->user()->can('view-strength')){
            ...
            return DataTables::of($data)
                ...
                ->addColumn('action', function ($row) {
                    ...
                    <button class="btn btn-md dropdown-toggle" type="button" data-toggle="dropdown" aria-expanded="false" ><i class="fa fa-ellipsis-v" aria-hidden="true"></i></button>
                        ...
                        if(auth('admin')->user()->can('edit-strength')){

                        $action.='<a data-href="'.route('backend.itemconfig.strenght.edit', $row).'" class="dropdown-item edit_check"
                            data-toggle="tooltip" data-original-title="Edit"><i class="fa fa-edit mr-2" aria-hidden="true"></i> Edit
                        </a>';}
                        if(auth('admin')->user()->can('delete-strength')){
    ...
    {
        if(auth('admin')->user()->can('create-strength')){
