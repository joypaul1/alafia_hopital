            ...
            return Datatables::of($data)
                ...
                ->addColumn('action', function ($row) {
                    ...
                    <button class="btn btn-md dropdown-toggle" type="button" data-toggle="dropdown" aria-expanded="false" ><i class="fa fa-ellipsis-v" aria-hidden="true"></i></button>
                        ...
                        <a data-href="'.route('backend.itemconfig.category.edit', $row).'" class="dropdown-item edit_check"
                            data-toggle="tooltip" data-original-title="Edit"><i class="fa fa-edit mr-2" aria-hidden="true"></i> Edit
                        </a>
                        <div class="dropdown-divider"></div>
                        <a data-href="'.route('backend.itemconfig.category.destroy', $row).'"class="dropdown-item delete_check"  data-toggle="tooltip"
