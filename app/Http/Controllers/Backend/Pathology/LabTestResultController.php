...
class LabTestResultController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        if ($labTest->category == 'Micro Biology' &&  $labTest->name == 'Blood - C/S') {
            return view('backend.pathology.makeResult.checkGrowthOrNot', compact('data', 'labTest'));
        }
        // dd($labTest->name);
        if ($labTest->category == 'Urine' &&  $labTest->name == 'Urine - C/S') {
            return view('backend.pathology.makeResult.urine.checkGrowthOrNot', compact('data', 'labTest'));
        }
        // start Biochemistry
        ...
        if ($labTest->category == 'Serology' && $labTest->name == 'Blood Group') {
            return view('backend.pathology.makeResult.serology.rhFactor', compact('data', 'labTest'));
        }
    ...
    public function store(Request $request)
    {
        try {
            ...
            if (($testName->category == 'Micro Biology' && $testName->name == 'Blood - C/S' && $request->growth == 'Yes')) {
                $data['lab_test_id']                    = $request->test_id;
                $data['lab_invoice_test_detail_id']     = $request->lab_invoice_test_detail_id;
                $data['created_by']                     = auth('admin')->user()->id;
                $data['created_date']                   = date('Y-m-d h:i:s');
            ...
            // dd($testName,$testName->name == 'Urine - C/S' , $request->growth);
            if ($testName->category == 'Urine' && $testName->name == 'Urine - C/S' && $request->growth == 'Yes') {
                $data['lab_test_id']                    = $request->test_id;
                $data['lab_invoice_test_detail_id']     = $request->lab_invoice_test_detail_id;
                $data['created_by']                     = auth('admin')->user()->id;
                $data['created_date']                   = date('Y-m-d h:i:s');
            ...
            if ($testName->category == 'Urine' && $testName->name == 'Urine - C/S' && $request->growth == 'No') {
                $data['lab_test_id']                    = $request->test_id;
                $data['lab_invoice_test_detail_id']     = $request->lab_invoice_test_detail_id;
                $data['created_by']                     = auth('admin')->user()->id;
                $data['created_date']                   = date('Y-m-d h:i:s');
    ...
    public function edit(Request $request)
    {
        ...
        $labTestReport = LabTestReport::whereId($request->id)->with('labInvoiceTestDetails.labInvoice', 'patient', 'testName')->first();
        if ($labTestReport->testName->category == 'Hematology' && $labTestReport->testName->name == 'CBC') {
            return view('backend.pathology.makeResult.hematology.edit-cbc', compact('data', 'labTest', 'units', 'labTestReport'));
        }
        if ($labTestReport->testName->category == 'Hematology' && $labTestReport->testName->name == 'Prothrombin Time (PT)') {
            return view('backend.pathology.makeResult.hematology.edit-prothrombin', compact('data', 'labTest', 'units', 'labTestReport'));
        }
